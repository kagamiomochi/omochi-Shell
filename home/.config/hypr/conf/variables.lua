...
hl.animation({ leaf = "workspaces",         enabled = true,  speed = 5,    bezier = "softAccl",     style = "slidevert" })
hl.animation({ leaf = "specialWorkspace",   enabled = true,  speed = 5,    bezier = "softAccl",     style = "slidefadevert 20%" })
